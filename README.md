...
GTA Online, Roblox, League of Legends, Counter-Strike 2 and Minecraft (Java Edition) run on the V2 pipeline in `scripts/v2/`: an adapter produces events, they are
