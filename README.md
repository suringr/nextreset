...
GTA Online, Roblox, League of Legends, Counter-Strike 2, Minecraft (Java Edition) and PUBG run on the V2 pipeline in `scripts/v2/`: an adapter produces events, they are
